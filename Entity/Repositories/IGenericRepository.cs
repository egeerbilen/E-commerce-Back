...
namespace Core.Repositories
{
    public interface IGenericRepository<T> where T : class
    {
        ...
        Task<T> GetByIdAsync(int id); // Bu kod parçasında Task kullanımının temel nedeni, asenkron programlamayı desteklemektir.
        IQueryable<T> GetAll();
        ...
        // Eğer GetAll metodu, bir veritabanı sorgusunu temsil ediyorsa ve sorgunun veritabanında çalıştırılmasını istiyorsanız, IQueryable<T> kullanmak genellikle daha uygun olacaktır.
        // IQueryable sorguları, genellikle veritabanına daha etkili bir şekilde çevrilebilir ve optimize edilebilir.
