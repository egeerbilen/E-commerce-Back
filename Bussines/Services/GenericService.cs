...
{
    // Best practice budur
    public class GenericService<Entity, Dto> : BaseUnitMapper, IGenericService<Entity, Dto> where Entity : BaseEntity where Dto : class
    {
        private readonly IGenericRepository<Entity> _repository;

        public GenericService(IGenericRepository<Entity> repository, IUnitOfWork unitOfWork, IMapper mapper) : base(unitOfWork, mapper)
        {
